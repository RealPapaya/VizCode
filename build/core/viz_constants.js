...
const FILE_TYPE_SHAPE = {
  ...
  // ── JVM / Mobile ──────────────────────────────────────────────────────────
  "java_source": { sh: "round-rectangle", w: 165, h: 48 },
  // Java — rounded, enterprise
  "kotlin_source": { sh: "cut-rectangle", w: 165, h: 48 },
  // Kotlin — modern cut
  "scala_source": { sh: "rhomboid", w: 165, h: 48 },
  // Scala — functional+OOP
  "groovy_source": { sh: "round-rectangle", w: 160, h: 48 },
  "dart_source": { sh: "bottom-round-rectangle", w: 165, h: 48 },
  // Dart — like TS family
  "swift_source": { sh: "cut-rectangle", w: 165, h: 48 },
  // Swift — modern, sharp
  "objc_source": { sh: "round-rectangle", w: 165, h: 48 },
  // ObjC — classic rounded
  // ── .NET ──────────────────────────────────────────────────────────────────
  "csharp_source": { sh: "round-rectangle", w: 165, h: 48 },
  "vb_source": { sh: "round-rectangle", w: 160, h: 48 },
  "fsharp_source": { sh: "rhomboid", w: 165, h: 48 },
  // F# — functional
  // ── Scripting ─────────────────────────────────────────────────────────────
  "ruby_source": { sh: "diamond", w: 170, h: 56 },
  // Ruby — gem shape
  "php_source": { sh: "round-rectangle", w: 160, h: 48 },
  "perl_source": { sh: "ellipse", w: 160, h: 48 },
  "lua_source": { sh: "ellipse", w: 155, h: 46 },
  "shell_source": { sh: "tag", w: 160, h: 46 },
  // Shell — command-like
  "r_source": { sh: "ellipse", w: 155, h: 46 },
  "julia_source": { sh: "ellipse", w: 160, h: 48 },
  // ── Systems ───────────────────────────────────────────────────────────────
  "rust_source": { sh: "hexagon", w: 175, h: 56 },
  // Rust — robust, like Go
  "zig_source": { sh: "hexagon", w: 170, h: 54 },
  // Zig — same systems family
  "d_source": { sh: "ellipse", w: 155, h: 48 },
  "nim_source": { sh: "cut-rectangle", w: 160, h: 48 },
  // Nim — modern systems
  "crystal_source": { sh: "diamond", w: 170, h: 56 },
  // Crystal — like Ruby
  // ── Functional ────────────────────────────────────────────────────────────
  "elixir_source": { sh: "rhomboid", w: 170, h: 50 },
  // Elixir — functional
  "erlang_source": { sh: "octagon", w: 170, h: 54 },
  // Erlang — robust/unique
  "clojure_source": { sh: "ellipse", w: 165, h: 50 },
  // Clojure — Lisp circles
  "haskell_source": { sh: "rhomboid", w: 170, h: 50 },
  // Haskell — pure functional
  "ocaml_source": { sh: "rhomboid", w: 165, h: 48 },
  // OCaml — functional family
  "elm_source": { sh: "round-rectangle", w: 160, h: 46 },
  // ── Data / Schema ─────────────────────────────────────────────────────────
  "sql_source": { sh: "barrel", w: 165, h: 50 },
  // SQL — database barrel
  "graphql_source": { sh: "concave-hexagon", w: 170, h: 50 },
  // GraphQL — API shape
  "proto_source": { sh: "round-tag", w: 165, h: 48 },
  // Proto — message tag
  // ── Web / Styles ──────────────────────────────────────────────────────────────
  "css_source": { sh: "ellipse", w: 150, h: 46 },
  // CSS — simple ellipse
  "scss_source": { sh: "ellipse", w: 160, h: 48 },
  // SCSS — enhanced CSS
  "sass_source": { sh: "ellipse", w: 160, h: 48 },
  // SASS — same as SCSS
  "less_source": { sh: "ellipse", w: 155, h: 46 },
  // LESS — CSS preprocessor
  "stylus_source": { sh: "ellipse", w: 160, h: 46 },
  // Stylus — flexible syntax
  "html_source": { sh: "round-tag", w: 165, h: 48 },
  // HTML — markup tag
  // ── Config / Data ──────────────────────────────────────────────────────────────
  "json_config": { sh: "round-rectangle", w: 165, h: 48 },
  // JSON — configuration file
  "yaml_source": { sh: "cut-rectangle", w: 160, h: 46 },
  // YAML — config
  "toml_source": { sh: "cut-rectangle", w: 160, h: 46 },
  // TOML — config
  "powershell_source": { sh: "tag", w: 165, h: 46 },
...
function fileNodeData(f, modColor) {
  ...
  let ttLines = [`${f.label}`, `\xA7${f.path}\xA7`];
...
function otherFileNodeData(f) {
  ...
  return {
    ...
    simple: isSimple ? 1 : 0,
    isExtra: true,
    // used by CY_STYLE selector for dimmed rendering
    tt: ttLines.join("\n"),
    _t: "file",
    _f: f
  };
