...
<div class="dash-list-row" data-clickable="true" data-tip="${_dashEscape(a.author)}"
  ...
  <span class="dash-list-name">${_dashEscape(a.author)}<span class="dash-list-meta">${a.commits} ${_dashEscape(_dashT("dashTemporalCommits"))} \xB7 <span class="dash-diff-add">+${adds}</span> / <span class="dash-diff-del">-${dels}</span></span></span>
