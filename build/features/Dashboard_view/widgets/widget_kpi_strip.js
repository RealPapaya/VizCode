function _dashRenderKpiStrip(container, stats) {
  ...
  const cards = [
    ...
    },
    {
      ...
      sub: `${_dashFmtNum(stats.loc_code || 0)} code \xB7 ${_dashFmtNum(stats.loc_comment || 0)} comments`,
      accent: ACCENT
    },
    {
      id: "health",
...
<div class="dash-card">
  ...
  <div style="display:flex;flex-direction:column;gap:12px;margin-top:16px;">
    <div class="dash-health-row">
      ...
      <div class="dash-health-row-track" style="flex:1;"><div class="dash-health-row-fill" style="width:${codePct}%;background:${_dashAccentTint(1)}"></div></div>
