...
<div id="app-shell">
  ...
  <aside id="app-rail">
    <div class="rail-brand-row">
      <div class="rail-logo" id="rail-logo-toggle" role="button" tabindex="0" data-i18n-attr="data-tip" data-i18n="railExpand" data-tip="Expand rail" title="Expand rail" style="position: relative; display: flex; justify-content: center; align-items: center; background: none; border-radius: 0; border: none; box-shadow: none;"><img class="rail-logo-img" src="/static/icon/LOGO.webp" alt="Logo" style="width: 65px; height: 65px; flex-shrink: 0; object-fit: contain; pointer-events: none;" /><svg class="rail-logo-expand" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 18l6-6-6-6"/></svg></div>
...
def build_html(data: dict, job_id: str = None) -> str:
    ...
    css_assets = [
        ...
        base / 'styles' / 'overlays' / 'overlays_general.css',
        base / 'styles' / 'overlays' / 'dashboard_shell.css',
        base / 'styles' / 'overlays' / 'dashboard_widgets.css',
        base / 'styles' / 'overlays' / 'dashboard_detail_panels.css',
        base / 'styles' / 'overlays' / 'dashboard_customize.css',
        base / 'styles' / 'overlays' / 'dashboard_architecture_widgets.css',
        base / 'styles' / 'overlays' / 'dashboard_print.css',
        base / 'styles' / 'overlays' / 'dashboard_architecture_panels.css',
    ...
    js_assets = [
        ...
        base / 'features' / 'Dashboard_view' / 'widgets' / 'widget_overview.js',
        # ── Core widgets ─────────────────────────────────────────────────────
        ...
        base / 'features' / 'galaxy_view' / 'viz_overview_flow.js',   # Overview shell flow (Galaxy/Treemap/Sankey)
        base / 'features' / 'galaxy_view' / 'viz_treemap.js',         # Overview treemap layout + interactions
        base / 'features' / 'galaxy_view' / 'viz_sankey.js',          # Overview Sankey flow + drill-down
