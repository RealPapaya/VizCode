// @module viz_utils — Shared utility functions (must load first)
// Owns: escapeHtml, escapeRe, dedupeBy, fmtSize, _pathDist, _distColor,
//       _distLabel, _safeId, _hashId, showToast, showMsg, showLoading,
