...
const _DASH_OPTIONAL_IDS = ['overview', 'dead_code', 'coupling', 'issues', 'circular_deps', 'entry_points', 'structure', 'graph_intelligence', 'churn_timeline', 'commit_heatmap', 'health_trend', 'bus_factor', 'branch_overview'];
