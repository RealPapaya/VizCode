...
// Code Health — SVG semi-circle gauge; sub-score bars revealed on click.

const _DASH_HEALTH_TRACK_LEN = Math.PI * 88; // semi-circle arc length (r=88)
...
function _dashRenderCodeHealth(container, stats) {
    ...
    container.innerHTML = `
<div class="dash-card dash-health-card">
  ...
  <div class="dash-health-gauge-area">
    <svg class="dash-health-gauge-svg" viewBox="0 0 220 130" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path class="dash-health-gauge-track"
            d="M 22 110 A 88 88 0 0 1 198 110"/>
      <path class="dash-health-gauge-fill"
            d="M 22 110 A 88 88 0 0 1 198 110"
  ...
  <div class="dash-health-detail" id="dash-health-detail"></div>
    ...
    document.getElementById('dash-health-expand-btn')
        ?.addEventListener('click', _dashToggleHealthDetail);
}

function _dashToggleHealthDetail() {
