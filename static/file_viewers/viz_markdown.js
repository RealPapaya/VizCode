// @module viz_markdown — Markdown file viewer
// Owns: renderMarkdown and associated markdown parsing functions
    ...
    if (window.hljs) {
        try {
            highlighted = language
                ? hljs.highlight(src, { language, ignoreIllegals: true }).value
