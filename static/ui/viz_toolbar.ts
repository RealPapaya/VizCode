...
function showNodeModal(node) {
    ...
    if (outEdges.length > 0 || inEdges.length > 0) {
        ...
        const renderList = (groups: any) => {
            for (const [key, nodes] of Object.entries(groups) as [string, any][]) {
...
function focusL2Func(fileRel, idx, opts: any = {}) {
...
function focusL2External(entry, opts: any = {}) {
...
function openL2File(fileRel, opts: any = {}) {
